...
INSERT INTO enemies (name, game_appearance, psychological_symbolism, otherworld_behavior) VALUES
  ('Raw Shock (male)', 'Silent Hill: Shattered Memory', '', ''),
  ('Raw Shock (female)', 'Silent Hill: Shattered Memory', '', ''),
  ('Raw Shock (Atrophied)', 'Silent Hill: Shattered Memory', '', ''),
  ('Raw Shock (Diseased)', 'Silent Hill: Shattered Memory', '', ''),
  ('Raw Shock (Abstract)', 'Silent Hill: Shattered Memory', '', '');
